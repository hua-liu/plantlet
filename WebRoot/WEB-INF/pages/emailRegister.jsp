...
<title><s:text name="emailRegister"/></title>
...
<body>
					...
					<li class="dropdown">
						...
						<ul class="nav" role="menu" aria-labelledby="dropdownMenu1">
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="emailRegisterUi?request_locale=zh_CN"><s:text
										name="chinese" /></a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1"
	...
	<div class="container">
		...
		<br /> <br />
		<form class="form-horizontal" action="emailRegisterUser" method="post"
			autocomplete="off" id="registerForm">
			<s:hidden name="registerType" value="email"></s:hidden>
			<div class="form-group">
				<label for="inputEmail"
					class="col-sm-2 control-label col-md-offset-3"><s:text name="email"/></label>
				<div class="col-sm-4">
					<input type="email" name="email" class="form-control" value="${email }" 
						id="inputEmail" placeholder="<s:text name="inputEmail"/>"> <span
