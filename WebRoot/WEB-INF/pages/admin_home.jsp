<%@ page language="java" import="cn.hua.formBean.Paging" pageEncoding="UTF-8"%>
...
<!--   <!-- Theme style -->
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="css/admin/datepicker3.css">
  <!-- Daterange picker -->
...
<body class="hold-transition skin-blue sidebar-mini">
	<%
		...
		if(paging!=null){
			paging.setClassify(0);	//进入主页后，更改刷新后类别
		}
	%>
      <!-- Info boxes -->
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="img/admin/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="img/admin/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="img/admin/user2-160x160.jpg" alt="user image" class="offline">
